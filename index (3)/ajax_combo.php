...
*/
	...
	$lookups = array(
		'Teachers_Table' => array(
			'Ph_number' => array(
				'parent_table' => 'Teachers_Table',
				'parent_pk_field' => 'Name',
				'parent_caption' => 'IF(CHAR_LENGTH(`Teachers_Table`.`Name`) || CHAR_LENGTH(`Teachers_Table`.`Email_id`), CONCAT_WS(\'\', `Teachers_Table`.`Name`, `Teachers_Table`.`Email_id`), \'\')',
				'parent_from' => '`Teachers_Table` LEFT JOIN `Teachers_Table` as Teachers_Table1 ON `Teachers_Table1`.`Name`=`Teachers_Table`.`Ph_number` ',
				'filterers' => array(),
				'custom_query' => '',
		...
		'Students_Table' => array(
			'ph_number' => array(
				...
				'parent_pk_field' => 'Name',
				'parent_caption' => '`Students_Table`.`Name`',
				'parent_from' => '`Students_Table` LEFT JOIN `Students_Table` as Students_Table1 ON `Students_Table1`.`Name`=`Students_Table`.`ph_number` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
