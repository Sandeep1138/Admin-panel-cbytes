	...
	/*************************************/
		...
		$pcConfig = array(
			'Teachers_Table' => array(
				'Ph_number' => array(
					'parent-table' => 'Teachers_Table',
					'parent-primary-key' => 'Name',
					'child-primary-key' => 'Name',
					'child-primary-key-index' => 0,
					'tab-label' => 'Teachers Table <span class="hidden child-label-Teachers_Table child-field-caption">(Ph number)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/account_balances.png',
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Email id', 2 => 'Ph number'),
					'display-field-names' => array(1 => 'Email_id', 2 => 'Ph_number'),
					'sortable-fields' => array(0 => '`Teachers_Table`.`Name`', 1 => 2, 2 => 3),
					'records-per-page' => 10,
					...
					'template' => 'children-Teachers_Table',
					'template-printable' => 'children-Teachers_Table-printable',
					'query' => "SELECT `Teachers_Table`.`Name` as 'Name', `Teachers_Table`.`Email_id` as 'Email_id', IF(    CHAR_LENGTH(`Teachers_Table1`.`Name`) || CHAR_LENGTH(`Teachers_Table1`.`Email_id`), CONCAT_WS('',   `Teachers_Table1`.`Name`, `Teachers_Table1`.`Email_id`), '') as 'Ph_number' FROM `Teachers_Table` LEFT JOIN `Teachers_Table` as Teachers_Table1 ON `Teachers_Table1`.`Name`=`Teachers_Table`.`Ph_number` "
				),
			),
