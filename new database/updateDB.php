<?php
	...
	if($thisMD5==$prevMD5) {
		...
		// set up tables
		setupTable('Teachers_Table', "create table if not exists `Teachers_Table` (   `Name` INT unsigned not null auto_increment , primary key (`Name`), `Email_id` VARCHAR(40) null , `Ph_number` INT unsigned null ) CHARSET utf8", $silent, array( " ALTER TABLE `Teachers_Table` CHANGE `Name` `Name` VARCHAR(40) not null "," ALTER TABLE `Teachers_Table` CHANGE `Name` `Name` INT unsigned not null auto_increment "," ALTER TABLE `Teachers_Table` CHANGE `Name` `Name` VARCHAR(40) not null "," ALTER TABLE `Teachers_Table` CHANGE `Name` `Name` INT unsigned not null auto_increment "));
